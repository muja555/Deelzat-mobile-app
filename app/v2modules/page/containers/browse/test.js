...
import Svg, {G, Text, TSpan, Path, Pattern, Image as ImageSVG} from 'react-native-svg';
...
class WheelOfFortune extends Component {
    ...
    makeWheel = () => {
        ...
        var colors = this.props.options.rewards.map(r => r.color)
                    ...
                    <AnimatedSvg
                        ...
                        <G y={width / 2} x={width / 2}>
                            {this._wheelPaths.map((arc, i) => {
                                ...
                                const segDegree = (this.oneTurn / this.numberOfSegments);
                                return (
                                    <>
                                        <G key={`arc-${i}`}>
                                            ...
                                            <G rotation={
                                                ...
                                                {
                                                    (this.props.options.rewards[i].prize) &&
                                                    <ImageSVG
                                                        x={x - (iconWidth / 2)}
                                                        y={y - (iconHeight / 2)}
                                                        width={iconWidth}
                                                        height={iconHeight}
                                                        href={require('assets/ss2.png')}
                                                    />
                                                }
                                            </G>
                                        </G>
